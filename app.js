...
function lose(userChoice, computerChoice) {
  ...
  const smallUserWord = "user".fontsize(3).sub();
  const smallCompWord = "comp".fontsize(3).sub();
  result_p.innerHTML = `${convertToWord(userChoice)}${smallUserWord} losses  ${convertToWord(computerChoice)}${smallCompWord}. You Lost!`;
...
function draw(userChoice, computerChoice) {
  const smallUserWord = "user".fontsize(3).sub();
  const smallCompWord = "comp".fontsize(3).sub();
  result_p.innerHTML = `${convertToWord(userChoice)}${smallUserWord} equels  ${convertToWord(computerChoice)}${smallCompWord}. It's a Draw!`;
